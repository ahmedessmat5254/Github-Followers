...
class GFUserInfoHeaderVC: UIViewController {
    ...
    let usernameTitleLabel = GFTitleLabel(textAlignment: .left, font: 34)
    ...
    func configureUIElement() {
        NetworkManager.shared.downloadImage(form: user.avatarUrl) { [weak self] image in
    ...
    func addSubView() {
        view.addSubViews(avatarImageView, usernameTitleLabel, nameLabel, locationImageView, locationLabel, bioLabel)
    }
